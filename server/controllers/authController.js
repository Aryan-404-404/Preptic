...
const registerUser = asyncHandler(async (req, res) => {
    const { name, email, password, chosenNiche, techStack } = req.body;

    if (!name || !email || !password || !chosenNiche) {
        res.status(400);
    ...
    const formattedNiche = chosenNiche.toLowerCase().trim();
